...
<html>
  <head>
    ...
    function submitSearch() {
        doSubmit('/kikin/workDateRequestCheckSearch.do');
    }
    /**
     * サブウィンドウを開く
     */
  ...
  <body>
    <div id="wrapper">
      ...
      <div id="businessBody" style="overflow: hidden; height: auto;">
            ...
            <html:link href="/kikin/workDateRequestCheckPage.do?paging=back">前へ</html:link>
            <html:link href="/kikin/workDateRequestCheckPage.do?paging=next">次へ</html:link>
