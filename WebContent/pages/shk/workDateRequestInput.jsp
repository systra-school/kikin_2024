...
<html>
  <head>
    ...
    function submitRegister() {
        // サブミット
        doSubmit('/kikin/workDateRequestInputRegister.do');
    }
    /**
     * 検索
     */
    function submitSearch() {
        doSubmit('/kikin/workDateRequestInputSearch.do');
    }
    /**
     * サブウィンドウを開く
     */
    ...
    function openSearch(){
    	window.open("/kikin/workDateRequestCheckSubInit.do", "searchPopup", "menubar=no, toolbar=no, scrollbars=auto, resizable=yes, width=1000px, height=600px")
    }
