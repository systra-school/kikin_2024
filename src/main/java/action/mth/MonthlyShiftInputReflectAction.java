/**
 * ファイル名：MonthlyShiftInputReflectAction.java
 *
 * 変更履歴
 ...
 * @author naraki
 */
public class MonthlyShiftInputReflectAction extends MonthlyShiftInputAbstractAction{
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        // 希望シフトIDを取得する
        Map<String,List<MonthlyShiftDto>> monthlyShiftDtoMap = monthlyShiftLogic.getMonthlyShiftDtoMap(yearMonth, false);
