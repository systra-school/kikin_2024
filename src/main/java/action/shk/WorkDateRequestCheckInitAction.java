/**
 * ファイル名：WorkDateRequestCheckInitAction.java
 *
 * 変更履歴
 ...
 *
 */
public class WorkDateRequestCheckInitAction extends WorkDateRequestAbstractAction{
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (CheckUtils.isEmpty(workRequestCheckDtoNestedList)) {
            ...
            workDateRequestCheckForm.setOffset(0);
            workDateRequestCheckForm.setCountPage(1);
            workDateRequestCheckForm.setMaxPage(CommonUtils.getMaxPage(workRequestCheckDtoNestedList.size(), SHOW_LENGTH));
        }
